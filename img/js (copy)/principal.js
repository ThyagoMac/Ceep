...
function adicionaCartao(conteudo, cor) {
    ...
    var botaoRemove = $("<button>").addClass("opcoesDoCartao-remove")
        .attr("data-ref", "cartao_" + contador).text("Remover").click(removeCartao);
    ...
    $("<div>").attr("id", "cartao_" + contador)
        .addClass("cartao").addClass(tipoCartao).append(opcoes).append(conteudoTag).css("background-color", cor).prependTo(".mural");
}
...
//escolha seu nome de usuarn aqui
    var mural = {
